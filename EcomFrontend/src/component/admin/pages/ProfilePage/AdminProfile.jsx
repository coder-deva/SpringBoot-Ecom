              ...
              <MDBRow className="g-0">
                  ...
                  <MDBCardImage
                    src={
                      imageFile
                        ...
                        : `/images/${admin?.profilePic || 'default.png'}`
                    }
                    alt="Profile"
                    className="my-4"
                    ...
                    fluid
                  />
                  <MDBTypography tag="h5">{admin?.name}</MDBTypography>
                ...
                <MDBCol md="8">
                  <MDBCardBody className="p-4">
                    <MDBTypography tag="h6">Admin Info</MDBTypography>
                    <hr className="mt-0 mb-4" />

                    <MDBRow className="pt-1">
                      <MDBCol size="6" className="mb-3">
                        <MDBTypography tag="h6">Username</MDBTypography>
                        <MDBCardText className="text-muted">{admin?.user?.username}</MDBCardText>
                      </MDBCol>
                    ...
                    <MDBRow>
                      ...
                      <MDBCol size="6" className="mb-3">
                        ...
                        {editMode ? (
                          ...
                          <MDBCardText className="text-muted">{admin?.phone}</MDBCardText>
                        )}
                      </MDBCol>
                    </MDBRow>
